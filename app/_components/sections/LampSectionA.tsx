        ...
        <div className="grid grid-cols-1 md:grid-cols-2  gap-8 mb-16">
          ...
          <h1 className="text-2xl font-semibold mb-4">
                  ...
                  <p className="list-disc pl-5 space-y-2">
                    Herbert Terry Anglepoise Lamps are iconic examples of
                    British industrial design, first introduced in 1934.
                    <br /><br />Designed by George Carwardine, a car designer
                    working for Herbert Terry &amp; Sons, the lamps are renowned
                    for their innovative spring-balanced mechanism, which allows
                    precise and effortless positioning. <br /><br />The
                    Anglepoise lamps became a symbol of functional modernist
