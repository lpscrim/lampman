...
export default function ShopNav({ type }: { type: string | string[] | undefined }) {
  return (
    <div className="mb-4 mt-4 px-1 sm:px-6 lg:flex lg:items-center lg:justify-between">
      <div className="mt-5 flex justify-between lg:ml-4 lg:mt-0">
        <div className="flex">
        ...
        <div className="flex sm:hidden flex-end">
          <h2 className="capitalize text-2xl font-bold tracking-tight mr-5 mt-2 text-text2">
            {type ? type : 'All'}
          </h2>
        </div>
      </div>
